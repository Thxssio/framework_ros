...
: ${AMENT_CURRENT_PREFIX:="/home/thxssio/robotics_framework/install/navigation_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/navigation_package/environment/library_path.sh"
