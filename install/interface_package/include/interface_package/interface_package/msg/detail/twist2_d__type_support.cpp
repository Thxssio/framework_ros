...
{
  new (message_memory) interface_package::msg::Twist2D(_init);
}

void Twist2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface_package::msg::Twist2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Twist2D_message_member_array[3] = {
  {
    ...
    offsetof(interface_package::msg::Twist2D, vx),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_package::msg::Twist2D, vy),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface_package::msg::Twist2D, omega),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Twist2D_message_members = {
  ...
  3,  // number of fields
  sizeof(interface_package::msg::Twist2D),
...
get_message_type_support_handle<interface_package::msg::Twist2D>()
{
  return &::interface_package::msg::rosidl_typesupport_introspection_cpp::Twist2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface_package, msg, Twist2D)() {
  return &::interface_package::msg::rosidl_typesupport_introspection_cpp::Twist2D_message_type_support_handle;
}
