...
#ifndef INTERFACE_PACKAGE__MSG__DETAIL__WORLD_STATE__FUNCTIONS_H_
#define INTERFACE_PACKAGE__MSG__DETAIL__WORLD_STATE__FUNCTIONS_H_
 ...
 * calls
 * interface_package__msg__WorldState__init().
...
/**
 * It calls
 * interface_package__msg__WorldState__fini()
 ...
 * interface_package__msg__WorldState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * interface_package__msg__WorldState__Sequence__fini()
 * on the array,
...
#endif  // INTERFACE_PACKAGE__MSG__DETAIL__WORLD_STATE__FUNCTIONS_H_
