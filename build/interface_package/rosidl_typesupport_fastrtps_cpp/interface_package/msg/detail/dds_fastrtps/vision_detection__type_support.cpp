...
#include "interface_package/msg/detail/vision_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_package::msg::VisionDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_package::msg::VisionDetection & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package::msg::VisionDetection;
    is_plain =
      (
      offsetof(DataType, ball) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const interface_package::msg::VisionDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_package::msg::VisionDetection *>(
    untyped_ros_message);
...
{
  return &interface_package::msg::typesupport_fastrtps_cpp::_VisionDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_package, msg, VisionDetection)() {
  return &interface_package::msg::typesupport_fastrtps_cpp::_VisionDetection__handle;
}
