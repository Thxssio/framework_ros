...
#include "interface_package/msg/detail/field_dimensions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_package::msg::FieldDimensions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_package::msg::FieldDimensions & ros_message)
{
  // Member: length
  cdr >> ros_message.length;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package::msg::FieldDimensions;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_package::msg::FieldDimensions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_package::msg::FieldDimensions *>(
    untyped_ros_message);
...
static size_t _FieldDimensions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FieldDimensions(full_bounded, is_plain, 0);
...
{
  return &interface_package::msg::typesupport_fastrtps_cpp::_FieldDimensions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_package, msg, FieldDimensions)() {
  return &interface_package::msg::typesupport_fastrtps_cpp::_FieldDimensions__handle;
}
