...
#include "interface_package/msg/detail/twist2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_package::msg::Twist2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_package::msg::Twist2D & ros_message)
{
  // Member: vx
  cdr >> ros_message.vx;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package::msg::Twist2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_package::msg::Twist2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_package::msg::Twist2D *>(
    untyped_ros_message);
...
{
  return &interface_package::msg::typesupport_fastrtps_cpp::_Twist2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_package, msg, Twist2D)() {
  return &interface_package::msg::typesupport_fastrtps_cpp::_Twist2D__handle;
}
