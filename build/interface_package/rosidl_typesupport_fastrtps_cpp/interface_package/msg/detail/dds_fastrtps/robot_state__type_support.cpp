...
#include "interface_package/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_package::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_package::msg::RobotState & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package::msg::RobotState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_package::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_package::msg::RobotState *>(
    untyped_ros_message);
...
{
  return &interface_package::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_package, msg, RobotState)() {
  return &interface_package::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
