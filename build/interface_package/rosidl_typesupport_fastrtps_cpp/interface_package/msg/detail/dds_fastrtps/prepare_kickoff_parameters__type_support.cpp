...
#include "interface_package/msg/detail/prepare_kickoff_parameters__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface_package::msg::PrepareKickoffParameters & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface_package::msg::PrepareKickoffParameters & ros_message)
{
  // Member: offset
  cdr >> ros_message.offset;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package::msg::PrepareKickoffParameters;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface_package::msg::PrepareKickoffParameters *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_package::msg::PrepareKickoffParameters *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PrepareKickoffParameters__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interface_package::msg::PrepareKickoffParameters *>(
...
static size_t _PrepareKickoffParameters__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PrepareKickoffParameters(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PrepareKickoffParameters__callbacks = {
...
static rosidl_message_type_support_t _PrepareKickoffParameters__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PrepareKickoffParameters__callbacks,
...
{
  return &interface_package::msg::typesupport_fastrtps_cpp::_PrepareKickoffParameters__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface_package, msg, PrepareKickoffParameters)() {
  return &interface_package::msg::typesupport_fastrtps_cpp::_PrepareKickoffParameters__handle;
}
