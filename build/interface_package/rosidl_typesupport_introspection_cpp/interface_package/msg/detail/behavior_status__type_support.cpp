...
{
  new (message_memory) interface_package::msg::BehaviorStatus(_init);
}

void BehaviorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface_package::msg::BehaviorStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BehaviorStatus_message_member_array[1] = {
  {
    ...
    offsetof(interface_package::msg::BehaviorStatus, value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BehaviorStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(interface_package::msg::BehaviorStatus),
...
{
  return &::interface_package::msg::rosidl_typesupport_introspection_cpp::BehaviorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface_package, msg, BehaviorStatus)() {
  return &::interface_package::msg::rosidl_typesupport_introspection_cpp::BehaviorStatus_message_type_support_handle;
}
