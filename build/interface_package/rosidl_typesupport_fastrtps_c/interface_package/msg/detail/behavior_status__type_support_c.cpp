...
#include "interface_package/msg/detail/behavior_status__rosidl_typesupport_fastrtps_c.h"
...
using _BehaviorStatus__ros_msg_type = interface_package__msg__BehaviorStatus;
...
static uint32_t _BehaviorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_package__msg__BehaviorStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package__msg__BehaviorStatus;
    is_plain =
      (
...
static size_t _BehaviorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_package__msg__BehaviorStatus(
