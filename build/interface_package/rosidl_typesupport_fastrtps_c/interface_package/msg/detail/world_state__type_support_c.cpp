...
#include "interface_package/msg/detail/world_state__rosidl_typesupport_fastrtps_c.h"
...
#include "interface_package/msg/detail/ball_state__functions.h"  // ball
#include "interface_package/msg/detail/field_dimensions__functions.h"  // field
#include "interface_package/msg/detail/robot_state__functions.h"  // friendly, opponent
#include "interface_package/msg/detail/team_color__functions.h"  // friendly_color
...
using _WorldState__ros_msg_type = interface_package__msg__WorldState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: friendly
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interface_package, msg, RobotState
      )()->data);
    size_t size = ros_message->friendly.size;
    auto array_ptr = ros_message->friendly.data;
  ...
  // Field name: opponent
  {
    ...
    auto array_ptr = ros_message->opponent.data;
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_serialize(
          &array_ptr[i], cdr))
  ...
  // Field name: ball
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interface_package, msg, BallState
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: friendly_color
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->friendly_color, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: friendly
  {
    ...
    if (ros_message->friendly.data) {
      interface_package__msg__RobotState__Sequence__fini(&ros_message->friendly);
    }
    if (!interface_package__msg__RobotState__Sequence__init(&ros_message->friendly, size)) {
      fprintf(stderr, "failed to create array for field 'friendly'");
      return false;
    }
    auto array_ptr = ros_message->friendly.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: opponent
  {
    ...
    if (ros_message->opponent.data) {
      interface_package__msg__RobotState__Sequence__fini(&ros_message->opponent);
    }
    if (!interface_package__msg__RobotState__Sequence__init(&ros_message->opponent, size)) {
      fprintf(stderr, "failed to create array for field 'opponent'");
      return false;
    }
    auto array_ptr = ros_message->opponent.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  size_t current_alignment)
{
  ...
  // field.name friendly
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_interface_package__msg__RobotState(
  ...
  current_alignment += get_serialized_size_interface_package__msg__BallState(
...
static uint32_t _WorldState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_package__msg__WorldState(
  ...
  size_t current_alignment)
{
  ...
  // member: friendly
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interface_package__msg__RobotState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: ball
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interface_package__msg__BallState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interface_package__msg__WorldState;
    is_plain =
      (
...
static size_t _WorldState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_package__msg__WorldState(
