...
#include "interface_package/msg/detail/robot_target__rosidl_typesupport_fastrtps_c.h"
...
#include "interface_package/msg/detail/pose2_d__functions.h"  // target
...
using _RobotTarget__ros_msg_type = interface_package__msg__RobotTarget;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RobotTarget__ros_msg_type * ros_message = static_cast<const _RobotTarget__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _RobotTarget__ros_msg_type * ros_message = static_cast<_RobotTarget__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_interface_package__msg__RobotTarget(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotTarget__ros_msg_type * ros_message = static_cast<const _RobotTarget__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RobotTarget__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_package__msg__RobotTarget(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface_package
size_t max_serialized_size_interface_package__msg__RobotTarget(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package__msg__RobotTarget;
    is_plain =
      (
...
static size_t _RobotTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_package__msg__RobotTarget(
...
static message_type_support_callbacks_t __callbacks_RobotTarget = {
...
static rosidl_message_type_support_t _RobotTarget__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RobotTarget,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_package, msg, RobotTarget)() {
  return &_RobotTarget__type_support;
}
