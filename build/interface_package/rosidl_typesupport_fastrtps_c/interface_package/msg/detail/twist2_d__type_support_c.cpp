...
#include "interface_package/msg/detail/twist2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Twist2D__ros_msg_type = interface_package__msg__Twist2D;
...
static uint32_t _Twist2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_package__msg__Twist2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package__msg__Twist2D;
    is_plain =
      (
...
static size_t _Twist2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_package__msg__Twist2D(
