...
#include "interface_package/msg/detail/team_color__rosidl_typesupport_fastrtps_c.h"
...
using _TeamColor__ros_msg_type = interface_package__msg__TeamColor;
...
static uint32_t _TeamColor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_package__msg__TeamColor(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface_package__msg__TeamColor;
    is_plain =
      (
...
static size_t _TeamColor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_package__msg__TeamColor(
