...
#include "interface_package/msg/detail/vision_geometry__rosidl_typesupport_fastrtps_c.h"
...
#include "interface_package/msg/detail/field_dimensions__functions.h"  // field
#include "rosidl_runtime_c/primitives_sequence.h"  // camera_ids
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // camera_ids
...
using _VisionGeometry__ros_msg_type = interface_package__msg__VisionGeometry;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: field
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interface_package, msg, FieldDimensions
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: expected_cameras
  {
    cdr << ros_message->expected_cameras;
  }

  // Field name: camera_count
  {
  ...
  {
    size_t size = ros_message->camera_ids.size;
    auto array_ptr = ros_message->camera_ids.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: camera_ids
  {
    ...
    if (ros_message->camera_ids.data) {
      rosidl_runtime_c__uint32__Sequence__fini(&ros_message->camera_ids);
    }
    if (!rosidl_runtime_c__uint32__Sequence__init(&ros_message->camera_ids, size)) {
      fprintf(stderr, "failed to create array for field 'camera_ids'");
      return false;
    }
    auto array_ptr = ros_message->camera_ids.data;
...
size_t get_serialized_size_interface_package__msg__VisionGeometry(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VisionGeometry__ros_msg_type * ros_message = static_cast<const _VisionGeometry__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_interface_package__msg__FieldDimensions(
...
static uint32_t _VisionGeometry__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface_package__msg__VisionGeometry(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface_package
size_t max_serialized_size_interface_package__msg__VisionGeometry(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: field
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interface_package__msg__FieldDimensions(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interface_package__msg__VisionGeometry;
    is_plain =
      (
...
static size_t _VisionGeometry__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface_package__msg__VisionGeometry(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface_package, msg, VisionGeometry)() {
