...
bool interface_package__srv__load_config__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.srv._load_config.LoadConfig_Request", full_classname_dest, 53) == 0);
  }
  interface_package__srv__LoadConfig_Request * ros_message = _ros_message;
  {  // kind
...
{
  /* NOTE(esteve): Call constructor of LoadConfig_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.srv._load_config");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LoadConfig_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool interface_package__srv__load_config__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.srv._load_config.LoadConfig_Response", full_classname_dest, 54) == 0);
  }
  interface_package__srv__LoadConfig_Response * ros_message = _ros_message;
  {  // ok
...
{
  /* NOTE(esteve): Call constructor of LoadConfig_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.srv._load_config");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LoadConfig_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
