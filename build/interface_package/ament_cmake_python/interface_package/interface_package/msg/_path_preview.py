...
class Metaclass_PathPreview(type):
    """Metaclass of message 'PathPreview'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'interface_package.msg.PathPreview')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__path_preview
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__path_preview
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__path_preview
            cls._TYPE_SUPPORT = module.type_support_msg__msg__path_preview
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__path_preview
...
class PathPreview(metaclass=Metaclass_PathPreview):
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Pose2D) for v in value) and
                 True), \
                "The 'direct' field must be a set or sequence and each value of type 'Pose2D'"
        self._direct = value
