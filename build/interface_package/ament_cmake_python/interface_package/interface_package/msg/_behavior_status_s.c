...
bool interface_package__msg__behavior_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._behavior_status.BehaviorStatus", full_classname_dest, 53) == 0);
  }
  interface_package__msg__BehaviorStatus * ros_message = _ros_message;
  {  // value
...
PyObject * interface_package__msg__behavior_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._behavior_status");
