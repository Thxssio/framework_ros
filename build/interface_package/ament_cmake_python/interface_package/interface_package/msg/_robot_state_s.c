...
bool interface_package__msg__robot_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._robot_state.RobotState", full_classname_dest, 45) == 0);
  }
  interface_package__msg__RobotState * ros_message = _ros_message;
  {  // id
  ...
  {  // pose
    ...
    if (!interface_package__msg__pose2_d__convert_from_py(field, &ros_message->pose)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // twist
    ...
    if (!interface_package__msg__twist2_d__convert_from_py(field, &ros_message->twist)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * interface_package__msg__robot_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._robot_state");
  ...
  {  // pose
    PyObject * field = NULL;
    field = interface_package__msg__pose2_d__convert_to_py(&ros_message->pose);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // twist
    PyObject * field = NULL;
    field = interface_package__msg__twist2_d__convert_to_py(&ros_message->twist);
    if (!field) {
      return NULL;
    }
    {
