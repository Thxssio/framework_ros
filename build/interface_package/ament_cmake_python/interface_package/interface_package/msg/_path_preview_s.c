...
bool interface_package__msg__path_preview__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // path
    ...
    if (!interface_package__msg__Pose2D__Sequence__init(&(ros_message->path), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create interface_package__msg__Pose2D__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    interface_package__msg__Pose2D * dest = ros_message->path.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!interface_package__msg__pose2_d__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // direct
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'direct'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    interface_package__msg__Pose2D * dest = ros_message->direct.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!interface_package__msg__pose2_d__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of PathPreview */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._path_preview");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PathPreview");
  ...
  {  // path
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = interface_package__msg__pose2_d__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // direct
    ...
    interface_package__msg__Pose2D * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->direct.data[i]);
      PyObject * pyitem = interface_package__msg__pose2_d__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
