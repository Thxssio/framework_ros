...
bool interface_package__msg__behavior_choice__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._behavior_choice.BehaviorChoice", full_classname_dest, 53) == 0);
  }
  interface_package__msg__BehaviorChoice * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of BehaviorChoice */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._behavior_choice");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BehaviorChoice");
