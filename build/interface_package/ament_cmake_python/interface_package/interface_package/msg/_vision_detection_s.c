...
bool interface_package__msg__vision_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._vision_detection.VisionDetection", full_classname_dest, 55) == 0);
  }
  interface_package__msg__VisionDetection * ros_message = _ros_message;
  {  // stamp
  ...
  {  // yellow
    ...
    if (!interface_package__msg__RobotState__Sequence__init(&(ros_message->yellow), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create interface_package__msg__RobotState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    interface_package__msg__RobotState * dest = ros_message->yellow.data;
  ...
  {  // blue
    ...
    if (!interface_package__msg__RobotState__Sequence__init(&(ros_message->blue), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create interface_package__msg__RobotState__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    interface_package__msg__RobotState * dest = ros_message->blue.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!interface_package__msg__robot_state__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
PyObject * interface_package__msg__vision_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._vision_detection");
