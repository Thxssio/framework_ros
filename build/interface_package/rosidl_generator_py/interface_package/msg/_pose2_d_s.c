...
bool interface_package__msg__pose2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._pose2_d.Pose2D", full_classname_dest, 37) == 0);
  }
  interface_package__msg__Pose2D * ros_message = _ros_message;
  {  // x
...
PyObject * interface_package__msg__pose2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._pose2_d");
