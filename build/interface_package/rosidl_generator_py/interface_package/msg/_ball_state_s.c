...
bool interface_package__msg__ball_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._ball_state.BallState", full_classname_dest, 43) == 0);
  }
  interface_package__msg__BallState * ros_message = _ros_message;
  {  // pose
...
PyObject * interface_package__msg__ball_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._ball_state");
