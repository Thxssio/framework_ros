...
bool interface_package__msg__team_color__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._team_color.TeamColor", full_classname_dest, 43) == 0);
  }
  interface_package__msg__TeamColor * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of TeamColor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._team_color");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TeamColor");
