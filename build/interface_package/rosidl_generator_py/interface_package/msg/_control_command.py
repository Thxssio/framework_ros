...
class Metaclass_ControlCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interface_package.msg import Twist2D
...
class ControlCommand(metaclass=Metaclass_ControlCommand):
    ...
    _fields_and_field_types = {
        ...
        'velocity': 'interface_package/Twist2D',
        'kick': 'boolean',
        'kick_speed': 'double',
        'dribbler': 'boolean',
        'dribbler_rpm': 'double',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['interface_package', 'msg'], 'Twist2D'),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.has_velocity = kwargs.get('has_velocity', bool())
        from interface_package.msg import Twist2D
        self.velocity = kwargs.get('velocity', Twist2D())
        self.kick = kwargs.get('kick', bool())
        self.kick_speed = kwargs.get('kick_speed', float())
        self.dribbler = kwargs.get('dribbler', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.has_velocity != other.has_velocity:
            return False
        ...
        if self.kick_speed != other.kick_speed:
            return False
        if self.dribbler != other.dribbler:
            return False
    ...
    def has_velocity(self):
        """Message field 'has_velocity'."""
        return self._has_velocity

    @has_velocity.setter
    def has_velocity(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'has_velocity' field must be of type 'bool'"
        self._has_velocity = value
    ...
    def kick(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'kick' field must be of type 'bool'"
        self._kick = value
    ...
    @builtins.property
    def dribbler(self):
        """Message field 'dribbler'."""
        return self._dribbler

    @dribbler.setter
    def dribbler(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'dribbler' field must be of type 'bool'"
        self._dribbler = value
